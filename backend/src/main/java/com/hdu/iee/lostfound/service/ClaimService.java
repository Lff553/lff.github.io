...
public class ClaimService {
    ...
    public ClaimResponse updateStatus(Long claimId, ClaimStatusUpdateRequest request) {
        ...
        if (status == ClaimStatus.APPROVED) {
            claim.getLostItem().setStatus(com.hdu.iee.lostfound.entity.LostItemStatus.CLAIMED);
        } else if (status == ClaimStatus.COMPLETED) {
            claim.getLostItem().setStatus(com.hdu.iee.lostfound.entity.LostItemStatus.RETURNED);
        }
